...
APP="$ROOT/apps/mac/.build/Better Watch.app"
mkdir -p "$APP/Contents/MacOS" "$APP/Contents/Resources"
cp "$ROOT/apps/mac/.build/release/BetterWatch" "$APP/Contents/MacOS/BetterWatch"
cp "$ROOT/scripts/remote/launch-mac.sh" "$APP/Contents/Resources/launch-mac.sh"
cp "$ROOT/apps/mac/Resources/AppIcon.icns" "$APP/Contents/Resources/AppIcon.icns"
cp "$ROOT/apps/mac/Resources/Playback-Libraries.txt" "$APP/Contents/Resources/"
cp "$ROOT/apps/mac/Resources/Playback-Distributor-Credits.rtf" "$APP/Contents/Resources/"
python3 "$ROOT/apps/mac/bundle-mpv.py" "$APP"
